    ...
    return (
        <div className={`${darkMode ? "bg-[#202c37]" : "" } py-[110px]`}>
            <div className="m-auto px-[90px] justify-between flex relative
                ...
                <div className={`${darkMode ? "bg-[#2b3945]" : "bg-white"} flex flex-col cursor-pointer w-[200px] px-6 relative shadow-lg rounded-md z-1 ta:w-[140px] sm:w-[60%] sm:mt-3 sm:px-3`}  onClick={() => ativarFilter()}>
                    <div className="flex h-[45px] items-center justify-between ta:h-[40px]">                       
                        ...
                        <img src={Arrow} alt="#" className={`${ darkMode ? "invert-[1]" : "" } w-6 relative md:absolute md:w-4 md:right-5 md:top-[14px] ta:top-[13px] ta:w-[14px] sm:right-3`}/>
                    </div>
